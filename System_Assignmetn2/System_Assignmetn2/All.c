...
/*
 • -c user and system CPU time used by the process 1
 • -m • -b • -a
 size of the operating residential memory used by the process
 number of block input and output operations performed by the process all options at once
*/
